...
Read `.cursor/skills/planning/plan-review/SKILL.md` in full. Use **Mode 2: Requirements Validation**. Treat the plan as
...
Read `.cursor/skills/planning/plan-review/SKILL.md` — use **Mode 1: Interactive Plan Review** (which references
...
Read `.cursor/skills/review/product-review/SKILL.md` in full (including its `review-process.md` reference) and follow
