...
Read `.cursor/skills/planning/write-plan/SKILL.md` in full and follow its workflow, using the matching plan mode (full,
...
Read `.cursor/skills/pipelines/review-plan-pipeline/SKILL.md` in full and follow its workflow.
...
2. When concluded, invoke `.cursor/skills/prototyping/decision-capture/SKILL.md` to record the outcome
3. On proceed, `.cursor/skills/prototyping/handoff-to-implementation/SKILL.md` creates the follow-up task
