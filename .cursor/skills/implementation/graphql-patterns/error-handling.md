...
your error handling documentation for the full guide.
...
resolvers as plain `async` functions and configure non-default `clientMessage`, `code`, logging `extra`, non-root fields,
or `false` opt-outs in `your root error config module`.
