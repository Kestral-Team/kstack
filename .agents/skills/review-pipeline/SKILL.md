...
Read `.agents/skills/code-review/SKILL.md` in full (including its `review-process.md` and `checks.md` references)
...
Read `.agents/skills/fix-issues/SKILL.md` in full and follow its workflow. Take the issues from the code
...
Read `.agents/skills/code-simplify/SKILL.md` in full (including its `patterns.md` reference) and follow its
...
Read `.agents/skills/deslop/SKILL.md` in full and follow its workflow. Strip AI-generated slop from the branch
...
Read `.agents/skills/context-evolve/SKILL.md` in full and follow its workflow. Scan the thread for new learnings
...
Read `.agents/skills/documentation-update/SKILL.md` in full and follow its workflow. Identify which documentation
